...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    ""
        ...
        <div class="row post-title-container">
            <?php if (is_single()):
                the_title(
                    "<div class='post-title-single col-common-3 col-common-offset-4 col-fhd-expand-4 col-wqhd-expand-4 col-fhd-expand-offset-6 col-wqhd-expand-offset-6'>",
                    "</div>"
                );
            else:
                the_title(
                    "<div class='post-title-index col-common-3 col-common-offset-4 col-fhd-expand-4 col-wqhd-expand-4 col-fhd-expand-offset-6 col-wqhd-expand-offset-6'>",
                    "</div>"
                );
            endif; ?>
        </div>
    ...
    <div class="row post-content">
        <?php the_content(
            sprintf(__("Read more...", "galaxy-domain"), get_the_title())
        ); ?>
    </div>
